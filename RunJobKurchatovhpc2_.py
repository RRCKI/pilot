	    ...
	    cpu_number = 1 #temporary
            ...
            try:
                ...
                try:
                    ...
                    #cons_time = datetime.strptime(fork_job.finished, '%Y-%m-%dT%H:%I:%S') - datetime.strptime(fork_job.started, '%Y-%m-%dT%H:%I:%S')   # '2014-12-16T13:48:5
                    cons_time = datetime.strptime(fork_job.finished, '%Y-%m-%dT%H:%M:%S') - datetime.strptime(fork_job.started, '%Y-%m-%dT%H:%M:%S')   # '2014-12-16T13:48:50'
