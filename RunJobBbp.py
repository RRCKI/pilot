...
class RunJobBbp(RunJobHPC):

    # private data members
    __runjob = "RunJobBbp"                          # String defining the sub class
    ...
    def stageIn(self, job, jobSite, analysisJob, pfc_name="PoolFileCatalog.xml"):
        ...
        return super(RunJobBbp,self).stageIn( job, jobSite, analysisJob, pfc_name)
        # if ct != 'sshmv':
    ...
    def getRunJobFileName(self):
        ...
        return super(RunJobBbp, self).getRunJobFileName()
...
#                # (stage-out ends here) .......................................................................
        ...
        job.jobState = "stageout"
        rt = RunJobUtilities.updatePilotServer(job, runJob.getPilotServer(), runJob.getPilotPort())
        tolog("Changing to finished state")
        ...
        if runJob.getGlobalPilotErrorDiag() != "":
            pilotErrorDiag = "Exception caught in runJobBbp: %s" % (runJob.getGlobalPilotErrorDiag())
        else:
            pilotErrorDiag = "Exception caught in runJobBbp: %s" % str(errorMsg)
